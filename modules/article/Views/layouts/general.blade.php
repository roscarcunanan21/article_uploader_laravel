	...
	<body id="js-body">
		...
		<header class="l-header  js-header">
		    <div class="l-header-top u-clear">	        
				...
				<div class="logo ">
				    <img src="{{ baseurl() }}assets/images/logo.png" width="253" height="28" alt="BLOG"/>
				</div>	
	            </div>
	    ...
	    <nav class="nav js-nav">
		    <ul class="nav-list">
		        <li class="nav-item">		        	
		            <a href="{{ baseurl() }}admin/login" class="nav-link"><?php if($user = Auth::user()){echo "Admin";}else{echo "Login";}?></a>
		        </li>
		        <li class="nav-item">
		            <a href="{{ baseurl() }}article" class="nav-link">TOP</a>
		        </li>
		        <li class="nav-item">
